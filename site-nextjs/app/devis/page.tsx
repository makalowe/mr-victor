...
export const metadata:Metadata={title:"Devis bornes de recharge entreprise",description:"Qualifiez votre projet multi-sites et recevez une réponse d’un expert sous 24h ouvrées."};
