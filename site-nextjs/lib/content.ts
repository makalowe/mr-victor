...
export const articles = [
  { slug: "aides-recharge-belgique-france", title: "Installation de bornes électriques en Belgique : quelles aides vérifier ?", category: "Financement", excerpt: "Dispositifs régionaux ou français, éligibilité et pièces à préparer avant de lancer votre installation de bornes électriques.", readTime: "7 min", publishedAt:"2026-06-18", keyword:"installation de bornes électriques Belgique Hauts-de-France" },
  { slug: "dimensionner-bornes-flotte", title: "Comment dimensionner l’installation de bornes électriques d’une flotte ?", category: "Guide technique", excerpt: "Une méthode pragmatique fondée sur les kilomètres, les temps d’arrêt et la puissance réellement disponible.", readTime: "9 min", publishedAt:"2026-06-04", keyword:"installation bornes électriques flotte entreprise" },
  { slug: "obligations-parking-entreprise", title: "Installation de bornes électriques sur un parking d’entreprise : les obligations", category: "Réglementation", excerpt: "Les points de vigilance pour les propriétaires, exploitants et directions immobilières en Belgique et dans les Hauts-de-France.", readTime: "6 min", publishedAt:"2026-05-21", keyword:"obligation installation bornes électriques parking entreprise" },
  ...
  { slug: "pilotage-dynamique-puissance", title: "Bornes électriques : installer plus de points sans augmenter la puissance", category: "Énergie", excerpt: "Comment répartir la puissance disponible entre véhicules, bâtiment et production sans fragiliser l’exploitation.", readTime: "8 min", publishedAt:"2026-04-23", keyword:"pilotage installation bornes électriques entreprise" },
  { slug: "cahier-charges-bornes-multisites", title: "Le cahier des charges d’une installation de bornes électriques multi-sites", category: "Achats", excerpt: "Les critères techniques, opérationnels et contractuels à intégrer dans un appel d’offres en Belgique et dans les Hauts-de-France.", readTime: "10 min", publishedAt:"2026-04-09", keyword:"cahier des charges installation bornes électriques" },
];
